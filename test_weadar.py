import unittest
from weadar import (get_location, get_zipcode, get_countrycode,
                    print_header, get_weather)
...
class test_get_location(unittest.TestCase):
    ...
    # impossible to test since it calls another function and live data is
    # always changing
